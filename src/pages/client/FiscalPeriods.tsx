...
const FiscalPeriods = () => {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">{isRTL ? "إضافة فترة مالية" : "Add Fiscal Period"}</h1>
        </div>
        <Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle className="flex items-center gap-2"><Clock className="h-5 w-5" />{isRTL ? "الفترات المالية" : "Fiscal Periods"}</CardTitle></CardHeader>
        <CardContent>
