    ...
    <div className={`space-y-6 ${isRTL ? "rtl" : "ltr"}`}>
      ...
      <DataTable
        ...
        emptyState={{
          ...
          description: isRTL ? "ابدأ بإضافة أول عميل" : "Start by adding your first customer",
          actionLabel: isRTL ? "إضافة عميل" : "Add Customer",
          onAction: () => navigate("/client/contacts/new?type=customer"),
        }}
      />
